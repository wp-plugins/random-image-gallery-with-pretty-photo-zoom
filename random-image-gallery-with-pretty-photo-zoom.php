...
function rigwppz_admin_option() 
{
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2011/12/12/wordpress-plugin-random-image-gallery-with-pretty-photo-zoom/'>Click here</a> to check official website for live demo<br> 
    <br>
	<?php
	echo "</div>";
}
