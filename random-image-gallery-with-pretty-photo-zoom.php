...
function rigwppz_admin_option() 
{
    ...
    <a target="_blank" href='http://www.gopipulse.com/work/2011/12/12/wordpress-plugin-random-image-gallery-with-pretty-photo-zoom/'>Click here</a> to find the short code. <br> 
	<h2>Plugin live demo and Help</h2>
	Check official website for more information <a target="_blank" href='http://www.gopipulse.com/work/2011/12/12/wordpress-plugin-random-image-gallery-with-pretty-photo-zoom/'>Click here</a><br> 
    <br>
	<?php
	echo "</div>";
}
